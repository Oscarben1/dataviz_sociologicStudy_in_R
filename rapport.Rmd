...
Afin d'avoir un premier apperçu lors de l'exploration de nos données, nous avons réalisé un graph de corrélation des variables numériques de notre dataset. Cela nous a permis de voir que certaines variables étaient très corrélées, positivement ou négativement.<br>
Voici ce diagramme :
