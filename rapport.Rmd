...
plot2 <- ggplot(data2, aes(x = factor(guardian), y = health, fill = guardian )) + 
  geom_col() +
  labs( title = "Santé selon le tuteur", 
...
plot <- data %>% ggplot( aes(x = famrel, y = health)) +
  ...
  labs( title = "Santé selon la relation familiale",
        x = "Relation familiale", y = "État de santé") + 
  theme(legend.position = "none")
plot
...
plot1 <- ggplot(df, aes( x = Medu, y = mean_health, fill = Medu)) +
  geom_col() + 
  labs(title = "Santé selon l'éducation de maman",
  x = "Niveau d'études",
  y = "État de santé") + 
  theme(legend.position = "none") +
  scale_fill_discrete(type = "viridis") +
...
plot2 <- ggplot(df2, aes( x = Fedu, y = mean_health, fill = Fedu)) +
  geom_col() + 
  labs(title = "Santé selon l'éducation de papa",
  x = "Niveau d'études",
  y = "État de santé") + 
  theme(legend.position = "none") +
  scale_fill_discrete(type = "viridis") +
